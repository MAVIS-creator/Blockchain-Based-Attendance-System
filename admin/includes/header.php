<?php
/**
 * Shared Header Template for Admin Portal
...
<head>
    ...
    <script>
        // Custom SweetAlert2 theme helper for High-Q System
        const HighQSwal = Swal.mixin({
            customClass: {
                confirmButton: 'px-5 py-2.5 bg-primary text-white font-semibold rounded-lg text-sm mx-1 shadow hover:bg-navy-muted transition-colors',
...
<div class="min-h-screen flex">
    ...
    <aside class="fixed left-0 top-0 h-full w-sidebar-width bg-surface-container-lowest border-r border-border-subtle shadow-sm flex flex-col p-4 gap-2 z-50">
        ...
        <nav class="flex flex-col gap-1">
            ...
            <a class="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container transition-colors rounded-lg" href="../index.php" target="_blank">
    ...
    <main class="ml-sidebar-width flex-grow flex flex-col min-h-screen">
        ...
        <header class="sticky top-0 right-0 w-full z-40 backdrop-blur-md border-b border-border-subtle bg-surface-container-lowest/80 flex justify-between items-center h-topbar-height px-gutter">
            ...
            <div class="flex items-center gap-4">
                <a href="../index.php" target="_blank" class="flex items-center gap-2 px-3 py-1.5 bg-secondary-container/20 text-secondary font-semibold text-xs rounded-full border border-secondary-container/30 hover:bg-secondary-container/40 transition-colors">
                    <span class="w-2 h-2 rounded-full bg-secondary animate-pulse"></span> Public Kiosk Mode
                </a>
